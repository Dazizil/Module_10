...
import {CommentApiResponse, PostsApiResponse, User} from "@/app/types/apiResponse";
            ...
            <article className={styles['post-container']} data-testid={'post-card'}>
                <div className={styles['post-info-container']}>
                    <header className={styles['avatar-container']}>
                        <Image width={48} height={48} className={styles['avatar-img']} src={post.authorPhoto ? post.authorPhoto : '/assets/user-helena.png'} alt={'author avatar'}/>
